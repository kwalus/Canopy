...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.4.81-blue" alt="Version 0.4.81">
...
<p align="center">
  ...
  <a href="docs/GITHUB_RELEASE_v0.4.81.md"><strong>Release Notes</strong></a> ·
...
- **Docs/version alignment refresh** across `0.4.78` to `0.4.81`, updating the README, operator guides, and current release copy so public-facing pointers match the latest development surface.
...
| [docs/GITHUB_RELEASE_v0.4.81.md](docs/GITHUB_RELEASE_v0.4.81.md) | Product-forward GitHub release copy for the current release candidate |
