# Public Release Audit - Canopy 0.6.125
...
**Date:** 2026-05-14
**Scope:** Public-release readiness for the 0.6.x line through `0.6.125` - repo hygiene, docs clarity, public-safe wording, accidental internal-only leakage, first-run/setup friction, and obvious release blockers.
...
| Version alignment | Current app/package/README badge versions are aligned to `0.6.125`; API, MCP, agent onboarding, quickstart, peer-connect, and mentions docs now declare the same release scope |
