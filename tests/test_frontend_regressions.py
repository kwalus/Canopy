...
class TestFrontendRegressions(unittest.TestCase):
    ...
    def test_user_file_vault_ui_and_composer_picker_are_wired(self) -> None:
        ...
        self.assertIn('function canPreviewDigestionSource(source, canReadSources = false)', main_js)
        self.assertIn('Source preview requires source metadata access for this Digestion.', main_js)
