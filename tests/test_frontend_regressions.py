...
"""
    ...
    def test_channel_header_can_hide_agent_only_threads(self) -> None:
        ...
        self.assertIn('function shouldCapsuleAgentRun(messages)', channels_template)
        ...
        self.assertIn('Agent-run capsules are on; no dense agent runs were found in this loaded window.', channels_template)
