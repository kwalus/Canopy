...
class TestFrontendRegressions(unittest.TestCase):
    ...
    def test_user_file_vault_ui_and_composer_picker_are_wired(self) -> None:
        ...
        self.assertNotIn('function renderDigestionPackagePreviewHtml(previewId, payload)', main_js)
        self.assertNotIn('payload.kind === \'digestion_package\'', main_js)
        self.assertNotIn('global.copyDigestionPackageId = function(button)', main_js)
