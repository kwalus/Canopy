...
"""
    ...
    def test_channel_header_can_hide_agent_only_threads(self) -> None:
        ...
        self.assertIn('function renderAgentRunWorkEffortPanel(messages, brief, status, directArtifacts, deckItems, participants, capsuleId, userInfo = {})', channels_template)
