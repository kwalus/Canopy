...
class TestFrontendRegressions(unittest.TestCase):
    ...
    def test_user_file_vault_ui_and_composer_picker_are_wired(self) -> None:
        ...
        self.assertIn('function setVaultInlinePreviewExpanded(expanded)', main_js)
        self.assertIn('function emphasizeVaultInlinePreview()', main_js)
        self.assertIn('setVaultInlinePreviewExpandAvailable(true);', main_js)
        ...
        self.assertIn("inlinePreviewExpand.addEventListener('click'", main_js)
