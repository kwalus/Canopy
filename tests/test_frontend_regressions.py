...
class TestFrontendRegressions(unittest.TestCase):
    ...
    def test_tasks_have_detail_editor_and_inline_view_link(self) -> None:
        ...
        self.assertIn('{% block title %}Work - Canopy{% endblock %}', tasks_template)
        self.assertIn('id="workstream-overview-list"', tasks_template)
        self.assertIn('id="digestion-overview-list"', tasks_template)
        self.assertIn('id="structured-work-list"', tasks_template)
        self.assertIn('function loadWorkstreams()', tasks_template)
        self.assertIn('function loadDigestionOverview()', tasks_template)
        self.assertIn('function loadStructuredWork()', tasks_template)
        self.assertIn('function openWorkstreamFromWorkPage(workstreamId, button)', tasks_template)
        self.assertIn('function openDigestionFromWorkPage(digestionId, button)', tasks_template)
        self.assertIn('function setWorkListHtml(listEl, html)', tasks_template)
        self.assertIn('function setWorkListLoading(listEl, label)', tasks_template)
        self.assertIn('let workstreamOverviewLoaded = false;', tasks_template)
        self.assertIn('let digestionOverviewLoaded = false;', tasks_template)
        self.assertIn('data-work-open-workstream="${id}"', tasks_template)
        self.assertIn('data-work-open-digestion="${id}"', tasks_template)
        self.assertIn("window.CanopyWorkstreams.openDeck", tasks_template)
        self.assertIn("window.openCanopyDigestionReferenceDeck", tasks_template)
        self.assertIn('Digestion Deck reader is still loading. Use the folder button to manage it in Vault.', tasks_template)
        self.assertIn('title="Open Digestion in Deck"', tasks_template)
        self.assertIn('title="Manage in Vault"', tasks_template)
        self.assertIn('id="task-detail-backdrop"', tasks_template)
        self.assertIn('id="task-assignee-picker"', tasks_template)
        self.assertIn('id="task-detail-assignee-picker"', tasks_template)
        self.assertIn('id="task-required-output"', tasks_template)
        self.assertIn('id="task-success-criteria"', tasks_template)
        self.assertIn('id="workproduct-feed-list"', tasks_template)
        self.assertIn('id="task-notify-assignees"', tasks_template)
        self.assertIn('id="task-detail-notify-assignees"', tasks_template)
        self.assertIn('function renderTaskPeoplePicker(mode)', tasks_template)
        self.assertIn('Click into this field to pick assignees; selected people stay pinned here.', tasks_template)
        self.assertIn('function loadRecentWorkproducts(options)', tasks_template)
        self.assertIn('notify_assignees: !!(notifyEl && notifyEl.checked && assignees.length)', tasks_template)
        self.assertIn('notify_assignees: !!(document.getElementById(\'task-detail-notify-assignees\')?.checked)', tasks_template)
        self.assertIn('metadata.assignees = assignees;', tasks_template)
        ...
        self.assertIn("@ui.route('/ajax/work/structured_objects'", ui_routes)
        self.assertIn('def _notify_task_assignees(', ui_routes)
        self.assertIn("trigger_type='task_assignment'", ui_routes)
        self.assertIn("elif source_type == 'task' and source_id:", ui_routes)
        self.assertIn("request_manager.list_requests(", ui_routes)
        self.assertIn("objective_manager.list_objectives(", ui_routes)
        self.assertIn("collab_card_manager.list_cards(", ui_routes)
        self.assertIn("handoff_manager.list_handoffs(", ui_routes)
        self.assertIn("signal_manager.list_signals(", ui_routes)
    ...
    def test_digestion_reference_pills_open_deck_before_modal_fallback(self) -> None:
        ...
        self.assertIn('function openGlobalDigestionReferenceDeckWorkspace(digestionId, sourceEl, options = {})', main_js)
        self.assertIn('function fetchGlobalDigestionSummaryForDeck(digestionId, fallback = {})', main_js)
        self.assertIn('function buildGlobalDigestionDeckManifest(digestion)', main_js)
        self.assertIn('window.openCanopyDigestionReferenceDeck = openGlobalDigestionReferenceDeckWorkspace;', main_js)
        self.assertIn('/api/v1/digestions/${encodeURIComponent(id)}?summary=1', main_js)
    ...
    def test_admin_operator_surface_policy_hides_p2p_chrome_without_disabling_mesh(self) -> None:
        admin_template = (ROOT / 'canopy' / 'ui' / 'templates' / 'admin.html').read_text(encoding='utf-8')
        base_template = (ROOT / 'canopy' / 'ui' / 'templates' / 'base.html').read_text(encoding='utf-8')
        ui_routes = (ROOT / 'canopy' / 'ui' / 'routes.py').read_text(encoding='utf-8')

        self.assertIn('Operator Surface', admin_template)
        self.assertIn('operator-surface-card', admin_template)
        self.assertIn('Focused workspace surface', admin_template)
        self.assertIn('Full mesh surface', admin_template)
        self.assertIn('Custom surface', admin_template)
        self.assertIn('This is UI-only and does not disable P2P networking', admin_template)
        self.assertIn('data-surface-key="hide_peer_header"', admin_template)
        self.assertIn('data-surface-key="hide_meshspace_switcher"', admin_template)
        self.assertIn('data-surface-key="hide_connected_peers_sidebar"', admin_template)
        self.assertIn('data-surface-key="hide_meshes_nav"', admin_template)
        self.assertIn('data-surface-key="hide_trust_network_nav"', admin_template)
        self.assertIn('data-surface-key="hide_connect_nav"', admin_template)
        self.assertIn('/ajax/admin/operator-surface', admin_template)
        self.assertIn('function setupOperatorSurfaceControls()', admin_template)
        self.assertIn('P2P-facing chrome will be hidden after save, but networking remains enabled.', admin_template)

        self.assertIn("operator_surface_policy.get('hide_peer_header')", base_template)
        self.assertIn("operator_surface_policy.get('hide_meshspace_switcher')", base_template)
        self.assertIn("operator_surface_policy.get('hide_connected_peers_sidebar')", base_template)
        self.assertIn("operator_surface_policy.get('hide_meshes_nav')", base_template)
        self.assertIn("operator_surface_policy.get('hide_trust_network_nav')", base_template)
        self.assertIn("operator_surface_policy.get('hide_connect_nav')", base_template)

        self.assertIn("_OPERATOR_SURFACE_POLICY_KEY = 'operator_surface_policy_v1'", ui_routes)
        self.assertIn("'profile': 'full_mesh'", ui_routes)
        self.assertIn("'profile': 'focused_workspace'", ui_routes)
        self.assertIn('def _normalize_operator_surface_policy', ui_routes)
        self.assertIn('def _get_operator_surface_policy', ui_routes)
        self.assertIn('def _set_operator_surface_policy', ui_routes)
        self.assertIn("operator_surface_policy=_get_operator_surface_policy()", ui_routes)
        self.assertIn("@ui.route('/ajax/admin/operator-surface', methods=['GET'])", ui_routes)
        self.assertIn("@ui.route('/ajax/admin/operator-surface', methods=['POST'])", ui_routes)
        self.assertIn('Hidden items are UI-only; P2P capabilities remain enabled.', ui_routes)
    ...
    def test_user_file_vault_ui_and_composer_picker_are_wired(self) -> None:
        ...
        self.assertIn('function openDigestionDeckWorkspace(digestionId, button, options = {})', main_js)
        self.assertIn('function fetchDigestionReferenceSummary(digestionId, fallback = {})', main_js)
        self.assertIn("`${vaultUrls().digestions}?include_sources=0`", main_js)
        self.assertIn('global.openCanopyDigestionReferenceDeck = openDigestionReferenceDeckWorkspace;', main_js)
        self.assertIn('a[data-canopy-digestion-ref="1"][data-canopy-digestion-id]', main_js)
        self.assertIn('openDigestionReferenceDeckWorkspace(digestionId, anchor', main_js)
        self.assertIn("render_mode: 'digestion_workspace'", main_js)
    ...
    def test_sidebar_collapsed_state_is_compact_icon_rail(self) -> None:
        ...
        self.assertIn("href=\"{{ url_for('ui.work_page') }}\" data-title=\"Work\"", base_template)
        self.assertIn("request.endpoint in ['ui.work_page', 'ui.tasks_page']", base_template)
        self.assertIn('<span class="sidebar-nav-text">Work</span>', base_template)
    ...
    def test_vault_file_share_picker_is_not_clipped_in_file_views(self) -> None:
        ...
        self.assertIn('function vaultFileShareSelectedUsers(form)', main_js)
        self.assertIn('function setVaultFileShareSelectedUsers(form, users)', main_js)
        self.assertIn('function addVaultFileShareSelectedUser(form, user)', main_js)
        self.assertIn('function removeVaultFileShareSelectedUser(form, userId)', main_js)
        self.assertIn('data-vault-file-share-remove', main_js)
        self.assertIn('for (const recipient of recipients)', main_js)
        self.assertIn('Choose one or more users or agents before granting access.', main_js)
        self.assertIn('.vault-file-share-user.is-selected', vault_template)
        self.assertIn('.vault-file-share-chip', vault_template)
        self.assertIn('.vault-file-share-clear-all', vault_template)
...
"""
    ...
    def test_channel_header_can_hide_agent_only_threads(self) -> None:
        ...
        self.assertIn("CHANNEL_QUICK_MENTION_MODE_STORAGE_KEY", channels_template)
        self.assertIn("data-quick-mention-mode-toggle=\"channel\"", channels_template)
        self.assertIn("function toggleChannelQuickMentionMode(rail)", channels_template)
        self.assertIn("getChannelQuickMentionUsers(mentionMode === 'icons' ? 18 : 10)", channels_template)
        self.assertIn("peekChannelQuickMentionChip(chip, rail, 2200);", channels_template)
        self.assertIn(".channel-quick-mention-rail.is-icon-mode .channel-quick-mention-chip", channels_template)
    ...
    def test_deck_widget_manifests_are_typed_and_sanitized(self) -> None:
        ...
        self.assertIn('function setDeckDigestionFocus(host, mode)', main_js)
        self.assertIn('data-deck-digestion-focus="figures"', main_js)
        self.assertIn('data-deck-digestion-focus="chart"', main_js)
        self.assertIn('data-deck-digestion-open-figure-correction', main_js)
        self.assertIn('function openDeckDigestionFigureCorrectionEditor(button, draftText)', main_js)
        self.assertIn('data-deck-digestion-figure-correction-text', main_js)
        self.assertIn('data-deck-digestion-copy-figure-correction', main_js)
        self.assertIn('Correction draft opened for editing. Focus mode remains active.', main_js)
        self.assertIn('deckDigestionFigureCorrectionText(figure, sourceName, caption, vision', main_js)
        self.assertIn('AI analysis', main_js)
        self.assertIn('Correction draft', main_js)
        ...
        self.assertIn(".deck-digestion-workspace.is-figures-focus .deck-digestion-main", base_template)
        self.assertIn(".deck-digestion-workspace.is-chart-focus .deck-digestion-main", base_template)
        self.assertIn(".deck-digestion-workspace.is-figures-focus .deck-digestion-search-panel", base_template)
        self.assertIn(".deck-digestion-panel-actions", base_template)
        self.assertIn(".deck-digestion-figure-analysis", base_template)
        self.assertIn(".deck-digestion-figure-analysis-body", base_template)
        self.assertIn(".deck-digestion-figure-correction-editor", base_template)
        self.assertIn(".deck-digestion-figure-correction-text", base_template)
        self.assertIn(".deck-digestion-figure-correction-actions", base_template)
