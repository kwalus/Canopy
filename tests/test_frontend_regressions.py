...
"""
    ...
    def test_deck_widget_manifests_are_typed_and_sanitized(self) -> None:
        ...
        self.assertIn('No extracted PDF figures are available for this built Digestion', main_js)
        self.assertIn('Some PDFs store diagrams as vector/text content', main_js)
