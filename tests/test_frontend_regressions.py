...
"""
    ...
    def test_deck_widget_manifests_are_typed_and_sanitized(self) -> None:
        ...
        self.assertIn("function renderDeckDigestionValueChart(points)", main_js)
        self.assertIn("function renderDeckDigestionHistogram(points)", main_js)
        ...
        self.assertIn("Click a value bar or histogram bin to hide it from this view.", main_js)
