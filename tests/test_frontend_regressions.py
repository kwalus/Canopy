...
"""
    ...
    def test_channel_header_can_hide_agent_only_threads(self) -> None:
        ...
        self.assertIn('function buildAgentRunCapsuleMapNodes(messages, artifacts, maxNodes = AGENT_RUN_CAPSULE_MAP_MAX_NODES)', channels_template)
        self.assertIn('function renderAgentRunCapsuleSignalMap(messages, artifacts, capsuleId)', channels_template)
