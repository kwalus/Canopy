...
"""
    ...
    def test_channel_threads_expand_by_default_with_manual_collapse_controls(self) -> None:
        ...
        self.assertIn("html += renderThreadToggleHtml(safeThreadRootId, replies.length, { expanded: true, label: 'replies' });", channels_template)
    ...
    def test_source_advance_ui_affordances_are_wired_for_feed_channels_and_cards(self) -> None:
        ...
        self.assertIn('if (isChannelUnreadThreadFilterEnabled() || isChannelAttachmentThreadFilterEnabled() || isChannelRecentThreadFilterEnabled() || isChannelThreadActivitySortEnabled())', channels_template)
