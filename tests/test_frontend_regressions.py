...
"""
    ...
    def test_source_advance_ui_affordances_are_wired_for_feed_channels_and_cards(self) -> None:
        ...
        self.assertIn('if (isChannelUnreadThreadFilterEnabled() || isChannelAttachmentThreadFilterEnabled() || isChannelRecentThreadFilterEnabled() || isChannelThreadActivitySortEnabled() || isChannelFoldedThreadViewEnabled())', channels_template)
