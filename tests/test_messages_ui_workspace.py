...
class TestMessagesUiWorkspace(unittest.TestCase):
    ...
    def test_messages_page_renders_conversation_workspace(self) -> None:
        ...
        self.assertIn('data-dm-action="copy-text"', body)
        self.assertIn('Copy text', body)
        self.assertIn('data-message-copy-text="1"', body)
        ...
        self.assertIn('recipient-picker-panel', body)
        self.assertIn('recipient-picker-grid', body)
        self.assertIn('aria-multiselectable="true"', body)
        self.assertIn('Pick people and agents', body)
        self.assertIn('data-recipient-picker-filter="agent"', body)
        self.assertIn('data-recipient-picker-filter="human"', body)
        self.assertIn('function renderRecipientPicker()', body)
        self.assertIn('function toggleRecipientPickerUser(userId)', body)
        self.assertIn("fetchRecipientDirectory({ forceRefresh: true, limit: 120 })", body)
